...
- **Two-step accuracy pipeline** — `claude-sonnet-4` drafts the talk, `claude-haiku-4-5` peer-reviews and corrects it before display
...
The peer-review step (Haiku) is a stylistic / factuality check, not a substitute for human medical review.
